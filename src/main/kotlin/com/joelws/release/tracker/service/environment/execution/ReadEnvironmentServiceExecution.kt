...
*/open class ReadEnvironmentServiceExecution(private val environmentDao: EnvironmentDao) : ServiceExecution<String?, Environment?> {

    override fun execute(param: String?): Environment? = environmentDao.read(param)
}
