package com.joelws.release.tracker.aspect
...
*/@Aspect class LoggingAspect {
    ...
    @Pointcut("execution(* com.joelws.release.tracker.service..*Operation.execute(..))")
    fun operationMethods() {
    }

    @Pointcut("execution(* com.joelws.release.tracker.conversion..*Adapter.adapt(..))")
    fun adapterMethods() {
    }
