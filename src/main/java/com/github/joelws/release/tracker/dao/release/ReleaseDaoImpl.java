...
@Repository public class ReleaseDaoImpl extends GenericDaoImpl<Release, String> implements ReleaseDao
{
    ...
    @SuppressWarnings("unchecked") @Override public List<Release> list()
    {
