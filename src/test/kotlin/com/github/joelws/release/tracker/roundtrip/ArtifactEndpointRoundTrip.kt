package com.github.joelws.release.tracker.roundtrip

import com.github.joelws.release.tracker.boot.Application
import com.github.joelws.release.tracker.configuration.DbUnitConfig
...
open class ArtifactEndpointRoundTrip {
    ...
    fun canUpdateArtifact() {
        given()
                ...
                .statusCode(400)
                .contentType(JSON)
                .body("error", `is`("Unsupported operation"))
    }
